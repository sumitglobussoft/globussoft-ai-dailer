...
def build_call_context(
    ...
    if _is_marathi and (_product_persona or _product_call_flow):
        ...
        dynamic_context += (
            ...
            f"\n## RULE #2 — CHHOTA PAN COMPLETE VAKYA\n"
            f"- 1 sentence, 15-20 shabda MAX. PAN vakya PURNA kar, madhech tokU nakos.\n"
            f"- WRONG (incomplete): 'AEPS, money transfer, bill payment, ticket booking, insurance, loan seva ani sarkaari seva ashya vividh seva' (ADHYAT TOKLA!)\n"
            f"- RIGHT (complete): 'AEPS, money transfer, insurance ashya services ahet, detail meeting madhe sangto.'\n"
            f"- Pratyek response 'बघा' ne suru KARU NAKOS. Vivihdh shabda vapar.\n"
            f"- List dyaychi asel tar 3-4 items FAKTA sang, sagla list karu nakos.\n"
